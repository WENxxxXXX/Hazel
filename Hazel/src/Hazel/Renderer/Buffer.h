...
namespace Hazel
{
	...
	struct LayoutElement {
		...
		// ������Щ�����������������ǻ����GetComponentCount��ȡ��������������õ���ȷ�Ĵ�С
	...
	public:
		...
		//��� layout �� const������Ҫ const ���͵ĵ�����Э�� layout ��Ϊ range
	...
	private:
		void CalcOffsetAndStride()
		{
			...
			{
				element.Offset = offset;//��һ�����ֵ� offset Ϊ 0�������ۼ�
				offset += element.Size;
				m_Stride += element.Size;// Size �� LayoutElement �Ĺ��캯���б�������
			}
		}
	};
