// 'SceneCamera' Just a subclass of Hazel::Camera, 
// which is Specially designed for 'CameraComponent' when game is actuall running. 
// And because of that, we can simply use some member function in "SceneCamera::Camera"
// ( the member in struct "CameraComponent")
#pragma once
...
namespace Hazel
{
	...
	private:
		void UpdateProjection();// Update camera projection matrix( proj matrix was from parent class: Hazel::Camera)
	private:
