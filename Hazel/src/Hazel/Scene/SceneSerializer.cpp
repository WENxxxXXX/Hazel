...
namespace Hazel
{
    ...
    // Creating a file-stream allows us write data to the file,so that we can store data outside
    ...
    {
        // Not implemented
        HZ_CORE_ASSERT(false, "SerializeRuntime is not implemented yet");
    }
    ...
    {
        // Not implemented
        HZ_CORE_ASSERT(false, "DeserializeRuntime is not implemented yet");
        return false;
    }
