...
VULKAN_SDK = os.getenv("VULKAN_SDK") -- os.getenv("VULKAN_SDK") 用来获取环境变量 VULKAN_SDK 的值，通常是存储 Vulkan SDK（软件开发工具包）的安装路径
...
IncludeDir["shaderc"] = "%{wks.location}/Hazel/vendor/VulkanSDK/Include/shaderc"
...
Library["VulkaHazelils"] = "%{LibraryDir.VulkanSDK}/VkLayer_utils.lib"    --文件不存在
