...
VULKAN_SDK = os.getenv("VULKAN_SDK") -- os.getenv("VULKAN_SDK") ������ȡ�������� VULKAN_SDK ��ֵ��ͨ���Ǵ洢 Vulkan SDK�������������߰����İ�װ·��
...
Library["VulkaHazelils"] = "%{LibraryDir.VulkanSDK}/VkLayer_utils.lib"    --�ļ�������
